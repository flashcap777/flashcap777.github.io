...
Using data from [the Sonic Physics Guide on SonicRetro.org](http://info.sonicretro.org/Sonic_Physics_Guide), I accurately recreated the physics engine from the Sonic The Hedgehog Genesis/MegaDrive games. This is a short demonstration of the engine, showing movement mechanics, paralax scrolling, and enemy AI.
